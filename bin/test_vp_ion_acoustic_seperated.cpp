...
int main()
{
    ...
    nufi::dim1::dirichlet::set_config<double,4>(conf,write_potential);
    nufi::dim1::dirichlet::write_coeffs<double,4>(conf,write_potential);
    //nufi::dim1::dirichlet::write_coeffs<double,4>(conf,write_potential, 0,20);
    //write_potential.close();
    //std::ifstream read_potential("save_coeff.txt" );
    //nufi::dim1::dirichlet::read_config<double,4>(conf,read_potential);
    //nufi::dim1::dirichlet::compute_timestep<double,4>(conf,read_potential,1);
