...
electro_static_force<real, order>::electro_static_force(const nufi::dim1::config_t<real> &p_param,
...
real electro_static_force<real, order>::eval_ftilda( size_t n, real x,
														real u)
{
    if ( n == 0 ) return nufi::dim1::config_t<real>::f0(x,u);
    ...
    while ( --n )
    {
        ...
        return nufi::dim1::config_t<real>::f0(x,u);
    }
		...
		double z, double v, double u, double w, bool use_stoermer_verlet)
{
	...
	return nufi::dim3::config_t<double>::f0(x,y,z,v,u,w);
}
...
double electro_magnetic_force::E(size_t tn, double x, double y, double z, size_t i)
{
	...
	else if(tn == 0)
	{
		...
		{
		case 1:
			return nufi::dim3::eval<double, order>(x, y, z, coeffs_E_x_0.get(), param);
		case 2:
			return nufi::dim3::eval<double, order>(x, y, z, coeffs_E_y_0.get(), param);
		case 3:
			return nufi::dim3::eval<double, order>(x, y, z, coeffs_E_z_0.get(), param);
		default:
			throw std::runtime_error("Only 3d but index not equal 1,2 or 3!");
		}
	}
	else if(tn == 1)
	{
		...
		{
		case 1:
			return nufi::dim3::eval<double, order>(x, y, z, coeffs_E_x_1.get(), param);
		case 2:
			return nufi::dim3::eval<double, order>(x, y, z, coeffs_E_y_1.get(), param);
		case 3:
			return nufi::dim3::eval<double, order>(x, y, z, coeffs_E_z_1.get(), param);
		default:
			throw std::runtime_error("Only 3d but index not equal 1,2 or 3!");
		}
	}
