            ...
            matmul_t matmul, gmres_config<real> &config )
{
    ...
    using std::memcpy;
    using std::memset;
    using nufi::blas  :: gemv;
    using nufi::lapack::larfg;
    using nufi::lapack::larfx;
    using nufi::lapack::trtrs;
    using nufi::gmres_impl::givens_rotation_from_rho;
    using nufi::gmres_impl::generate_givens_rotation;
